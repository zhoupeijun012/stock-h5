...
export const routes = [
  {
    ...
    meta: { title: "首页", showTab: true, keepAlive: true },
  },
  {
    path: "/strategy",
    name: "strategy",
  ...
  },
  {
    ...
    meta: { title: "股票列表", keepAlive: true },
  },
  {
    path: "/industry",
    name: "industry",
    ...
    meta: { title: "行业列表", keepAlive: true },
  },
  {
    path: "/concept",
    name: "concept",
    ...
    meta: { title: "概念列表", keepAlive: true },
  },
  {
    path: "/region",
    name: "region",
  ...
  },
  {
    ...
    meta: { title: "T+0列表", keepAlive: true },
  },
  {
    path: "/t+1",
    name: "t+1",
    ...
    meta: { title: "T+1列表", keepAlive: true },
  },
  {
    path: "/lof",
    name: "lof",
    ...
    meta: { title: "LOF列表", keepAlive: true },
  },
  {
    path: "/login",
    name: "login",
